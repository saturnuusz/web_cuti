...
<body>
  ...
  <div class="dashboard">
    <div class="sidebar">
      ...
      <ul>
        <li><a href="dashboard3.php" target="iframetarget"><img src="images/home.png" class="icon" alt="Home Icon"><span class="icon-text">Halaman Utama</span></a></li>
        <li><a href="http://localhost/web_cuti/index.php/persetujuan/create" target="iframetarget"><img src="images/ajukan.png" class="icon" alt="User Icon"><span class="icon-text">Persetujuan Cuti</span></a></li>
