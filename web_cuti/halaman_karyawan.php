...
<head>
  ...
  <style>
    ...
    .head {
      ...
      box-shadow: 0 2px 5px rgba(192,192,); /* Added shadow */
    }
...
<body>
  ...
  <div class="dashboard">
    <div class="sidebar">
      ...
      <ul>
        <li><a href="dashboard2.php" target="iframetarget"><img src="images/home.png" class="icon" alt="Home Icon"><span class="icon-text">Halaman Utama</span></a></li>
        <li><a href="http://localhost/web_cuti/index.php/pengajuan/create" target="iframetarget"><img src="images/ajukan.png" class="icon" alt="User Icon"><span class="icon-text">Ajukan Cuti</span></a></li>
        <li><a href="riwayat.php" target="iframetarget"><img src="images/riwayat.png" class="icon" alt="Department Icon"><span class="icon-text">Riwayat Cuti</span></a></li>
    ...
    <div class="head main-content sidebar-visible">
      ...
      <a href="notif.php" target="iframetarget"><img src="images/notif.png" class="icon" alt="Akun Icon"></a>
        <a href="profil.php" target="iframetarget"><img src="images/user.png" class="icon" alt="Akun Icon"></a>
